...
- 所有引用的案例、事件、数据必须是最近 1-2 年内的，优先使用热点信息中提到的具体公司、产品、人物、数字
- 热点描述里提到的信息就是你最好的素材，从中提取具体细节展开，不要忽略它们
- 绝对不要用"2022年ChatGPT横空出世""AlphaGo打败李世石"这类被写烂了的老例子
- 如果需要补充背景信息，限定在与当前热点直接相关的范围内，不要跑题去讲 AI 发展史
