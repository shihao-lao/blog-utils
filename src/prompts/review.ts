...
- 使用 emoji 表情符号直接扣到 0.3 以下
- 黑话堆砌："赋能""底层逻辑""颗粒度""抓手""闭环""范式"——发现直接扣到 0.3 以下
...
- 观点都是大众共识，没有任何反直觉的判断
- 案例泛泛："很多人""很多公司""某些场景"
- 文章是否有"认知转折"——读者读到某个地方会停下来想"哦？是这样吗？"。好的文章至少有 2-3 个转折。没有转折的文章，内容分直接给 0.4 以下
